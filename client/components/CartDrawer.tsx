...
export default function CartDrawer({
  ...
  <Link href="/products/category">
    <button className="bg-[#03686d] text-white px-12 py-2 hover:bg-red-700 transition-colors duration-200">
      Start Shopping
    </button>
  </Link>
</div>
                ...
                <div className="grid grid-cols-[1fr_auto] items-center gap-2 border-b py-2">
  <div>
