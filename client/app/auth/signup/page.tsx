...
export default function SignupPage() {
        ...
        >
          <div className="flex flex-col justify-center items-center mb-6">
            ...
            <p className="text-gray-600 text-sm md:text-base text-center mt-2 px-3">
              Join now to explore the latest tech trends, enjoy exclusive offers,
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#00817c] text-white py-3 rounded cursor-pointer transition hover:bg-[#006c65]"
          >
  ...
  className={`w-full flex items-center justify-center gap-3 bg-white text-gray-700 border border-gray-300 py-3 rounded mb-4 mt-4 cursor-pointer transition hover:bg-gray-100 shadow-sm ${
